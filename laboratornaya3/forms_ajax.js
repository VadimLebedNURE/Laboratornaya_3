...
function getFilmsByDate() {
	...
	var date1 = document.getElementsByName("date_start")[0].value;
	var date2 = document.getElementsByName("date_end")[0].value;
	ajax.onreadystatechange = getFilmsByDateCallback;
	var params = 'date_start=' + encodeURIComponent(date1)+'&date_end='+ encodeURIComponent(date2);
